#!/bin/bash
for ((i=1825; i<=1825; i=i+5))
do
python3 test.py --dataset cifar10 --exp kl-f2-3 --epoch_id $i --num_channels 4 \
...
--batch_size 2000 --fid_only --real_img_dir cifar10_train_stat.npy
done
