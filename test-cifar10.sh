#!/bin/bash
for ((i=1000; i<=1000; i=i+5))
do
python3 test.py --dataset cifar10 --exp cifar10-spectralnorm-5 --epoch_id $i --num_channels 4 \
...
--batch_size 2000 --fid_only --real_img_dir pytorch_fid/cifar10_train_stat.npy
done
