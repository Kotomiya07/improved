#!/bin/bash
for ((i=1200; i<=1700; i=i+5))
do
python3 test_dit_no_ddp.py --dataset cifar10 --exp cifar10-ori-dit-no-ddp-s2-skip-connection-predict-noise-plus2 --epoch_id $i --num_channels 4 \
